...
export class TreeComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @Output()
  public filesDropped: EventEmitter<any> = new EventEmitter();
  ...
  public ngOnInit(): void {
    ...
    this.subscriptions.push(this.treeService.filesDropped$.subscribe((e: NodeEvent) => {
      this.filesDropped.emit(e);
    }));
  }
